...
abstract mixin class $BookingModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'client_rating') double clientRating,
      String tag,
      double price,
...
class _BookingModel extends BookingModel {
  const _BookingModel(
      ...
      @JsonKey(name: 'client_rating') required this.clientRating,
      required this.tag,
      required this.price,
      @JsonKey(name: 'pickup_location') required this.pickupLocation,
      @JsonKey(name: 'dropoff_location') required this.dropoffLocation,
...
abstract mixin class $TripModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'total_mileage') double totalMileage,
...
class _TripModel extends TripModel {
  const _TripModel(
      ...
      @JsonKey(name: 'total_rides') required this.totalRides,
