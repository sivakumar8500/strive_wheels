...
mixin _$BookingActionResponse {
  bool get success;
  BookingActionData get data;

  /// Create a copy of BookingActionResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $BookingActionResponseCopyWith<BookingActionResponse> get copyWith =>
      _$BookingActionResponseCopyWithImpl<BookingActionResponse>(
          this as BookingActionResponse, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is BookingActionResponse &&
...
abstract mixin class $BookingActionResponseCopyWith<$Res> {
  factory $BookingActionResponseCopyWith(BookingActionResponse value,
          $Res Function(BookingActionResponse) _then) =
      _$BookingActionResponseCopyWithImpl;
  @useResult
  $Res call({bool success, BookingActionData data});
...
extension BookingActionResponsePatterns on BookingActionResponse {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_BookingActionResponse value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool success, BookingActionData data)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _BookingActionResponse implements BookingActionResponse {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BookingActionResponseCopyWith<_BookingActionResponse> get copyWith =>
      __$BookingActionResponseCopyWithImpl<_BookingActionResponse>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _BookingActionResponse &&
            (identical(other.success, success) || other.success == success) &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class _$BookingActionResponseCopyWith<$Res>
    implements $BookingActionResponseCopyWith<$Res> {
  factory _$BookingActionResponseCopyWith(_BookingActionResponse value,
          $Res Function(_BookingActionResponse) _then) =
      __$BookingActionResponseCopyWithImpl;
  @override
  @useResult
  $Res call({bool success, BookingActionData data});
...
mixin _$BookingActionData {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $BookingActionDataCopyWith<BookingActionData> get copyWith =>
      _$BookingActionDataCopyWithImpl<BookingActionData>(
          this as BookingActionData, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is BookingActionData &&
...
abstract mixin class $BookingActionDataCopyWith<$Res> {
  factory $BookingActionDataCopyWith(
          BookingActionData value, $Res Function(BookingActionData) _then) =
      _$BookingActionDataCopyWithImpl;
  @useResult
  $Res call(
...
extension BookingActionDataPatterns on BookingActionData {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_BookingActionData value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String status,
    ...
    switch (_that) {
      case _BookingActionData() when $default != null:
        return $default(_that.id, _that.status, _that.finalFare);
      case _:
        return orElse();
    }
  }
...
class _BookingActionData implements BookingActionData {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BookingActionDataCopyWith<_BookingActionData> get copyWith =>
      __$BookingActionDataCopyWithImpl<_BookingActionData>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _BookingActionData &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.status, status) || other.status == status) &&
            (identical(other.finalFare, finalFare) ||
                other.finalFare == finalFare));
...
/// @nodoc
abstract mixin class _$BookingActionDataCopyWith<$Res>
    implements $BookingActionDataCopyWith<$Res> {
  factory _$BookingActionDataCopyWith(
          _BookingActionData value, $Res Function(_BookingActionData) _then) =
      __$BookingActionDataCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int id, String status, @JsonKey(name: 'final_fare') double? finalFare});
