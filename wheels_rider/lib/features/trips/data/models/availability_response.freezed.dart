...
mixin _$AvailabilityResponse {
  bool get success;
  AvailabilityData get data;

  /// Create a copy of AvailabilityResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $AvailabilityResponseCopyWith<AvailabilityResponse> get copyWith =>
      _$AvailabilityResponseCopyWithImpl<AvailabilityResponse>(
          this as AvailabilityResponse, _$identity);
...
abstract mixin class $AvailabilityResponseCopyWith<$Res> {
  factory $AvailabilityResponseCopyWith(AvailabilityResponse value,
          $Res Function(AvailabilityResponse) _then) =
      _$AvailabilityResponseCopyWithImpl;
  @useResult
  $Res call({bool success, AvailabilityData data});
...
extension AvailabilityResponsePatterns on AvailabilityResponse {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AvailabilityResponse value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool success, AvailabilityData data)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _AvailabilityResponse implements AvailabilityResponse {
  ...
  factory _AvailabilityResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AvailabilityResponseCopyWith<_AvailabilityResponse> get copyWith =>
      __$AvailabilityResponseCopyWithImpl<_AvailabilityResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AvailabilityResponseToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AvailabilityResponse &&
            (identical(other.success, success) || other.success == success) &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class _$AvailabilityResponseCopyWith<$Res>
    implements $AvailabilityResponseCopyWith<$Res> {
  factory _$AvailabilityResponseCopyWith(_AvailabilityResponse value,
          $Res Function(_AvailabilityResponse) _then) =
      __$AvailabilityResponseCopyWithImpl;
  @override
  @useResult
  $Res call({bool success, AvailabilityData data});
...
mixin _$AvailabilityData {
  @JsonKey(name: 'availability_mode')
  ...
  $AvailabilityDataCopyWith<AvailabilityData> get copyWith =>
      _$AvailabilityDataCopyWithImpl<AvailabilityData>(
          this as AvailabilityData, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.availabilityMode, availabilityMode) ||
...
abstract mixin class $AvailabilityDataCopyWith<$Res> {
  factory $AvailabilityDataCopyWith(
          AvailabilityData value, $Res Function(AvailabilityData) _then) =
...
class _$AvailabilityDataCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_self.copyWith(
      availabilityMode: null == availabilityMode
          ? _self.availabilityMode
          : availabilityMode // ignore: cast_nullable_to_non_nullable
              as String,
...
extension AvailabilityDataPatterns on AvailabilityData {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AvailabilityData value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _AvailabilityData() when $default != null:
        return $default(_that.availabilityMode, _that.isOnline);
      case _:
        return orElse();
    }
  }
...
class _AvailabilityData implements AvailabilityData {
  const _AvailabilityData(
      {@JsonKey(name: 'availability_mode') required this.availabilityMode,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AvailabilityDataCopyWith<_AvailabilityData> get copyWith =>
      __$AvailabilityDataCopyWithImpl<_AvailabilityData>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AvailabilityDataToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AvailabilityDataCopyWith<$Res>
    implements $AvailabilityDataCopyWith<$Res> {
  factory _$AvailabilityDataCopyWith(
          _AvailabilityData value, $Res Function(_AvailabilityData) _then) =
      __$AvailabilityDataCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'availability_mode') String availabilityMode,
