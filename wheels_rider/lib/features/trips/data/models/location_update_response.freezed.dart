...
mixin _$LocationUpdateResponse {
  ...
  $LocationUpdateResponseCopyWith<LocationUpdateResponse> get copyWith =>
      _$LocationUpdateResponseCopyWithImpl<LocationUpdateResponse>(
          this as LocationUpdateResponse, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is LocationUpdateResponse &&
...
abstract mixin class $LocationUpdateResponseCopyWith<$Res> {
  factory $LocationUpdateResponseCopyWith(LocationUpdateResponse value,
          $Res Function(LocationUpdateResponse) _then) =
      _$LocationUpdateResponseCopyWithImpl;
  @useResult
  $Res call({bool success, LocationData data});
...
extension LocationUpdateResponsePatterns on LocationUpdateResponse {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LocationUpdateResponse value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool success, LocationData data)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _LocationUpdateResponse implements LocationUpdateResponse {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LocationUpdateResponseCopyWith<_LocationUpdateResponse> get copyWith =>
      __$LocationUpdateResponseCopyWithImpl<_LocationUpdateResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$LocationUpdateResponseToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _LocationUpdateResponse &&
            (identical(other.success, success) || other.success == success) &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class _$LocationUpdateResponseCopyWith<$Res>
    implements $LocationUpdateResponseCopyWith<$Res> {
  factory _$LocationUpdateResponseCopyWith(_LocationUpdateResponse value,
          $Res Function(_LocationUpdateResponse) _then) =
      __$LocationUpdateResponseCopyWithImpl;
  @override
  @useResult
  $Res call({bool success, LocationData data});
