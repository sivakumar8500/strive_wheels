...
mixin _$QuickServiceModel {
  ...
  $QuickServiceModelCopyWith<QuickServiceModel> get copyWith =>
      _$QuickServiceModelCopyWithImpl<QuickServiceModel>(
          this as QuickServiceModel, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is QuickServiceModel &&
...
abstract mixin class $QuickServiceModelCopyWith<$Res> {
  factory $QuickServiceModelCopyWith(
          QuickServiceModel value, $Res Function(QuickServiceModel) _then) =
      _$QuickServiceModelCopyWithImpl;
  @useResult
  $Res call(
      {int id,
      String title,
...
extension QuickServiceModelPatterns on QuickServiceModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_QuickServiceModel value)? $default, {
...
class _QuickServiceModel implements QuickServiceModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$QuickServiceModelCopyWith<_QuickServiceModel> get copyWith =>
      __$QuickServiceModelCopyWithImpl<_QuickServiceModel>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _QuickServiceModel &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.title, title) || other.title == title) &&
            (identical(other.subtitle, subtitle) ||
                other.subtitle == subtitle) &&
...
/// @nodoc
abstract mixin class _$QuickServiceModelCopyWith<$Res>
    implements $QuickServiceModelCopyWith<$Res> {
  factory _$QuickServiceModelCopyWith(
          _QuickServiceModel value, $Res Function(_QuickServiceModel) _then) =
      __$QuickServiceModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int id,
