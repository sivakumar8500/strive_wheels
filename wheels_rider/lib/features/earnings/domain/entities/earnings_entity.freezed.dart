...
mixin _$EarningsActivityEntity {
  ...
  $EarningsActivityEntityCopyWith<EarningsActivityEntity> get copyWith =>
      _$EarningsActivityEntityCopyWithImpl<EarningsActivityEntity>(
          this as EarningsActivityEntity, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is EarningsActivityEntity &&
...
abstract mixin class $EarningsActivityEntityCopyWith<$Res> {
  factory $EarningsActivityEntityCopyWith(EarningsActivityEntity value,
          $Res Function(EarningsActivityEntity) _then) =
      _$EarningsActivityEntityCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String type,
...
extension EarningsActivityEntityPatterns on EarningsActivityEntity {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_EarningsActivityEntity value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String type, String title, String subtitle,
            double amount, DateTime timestamp)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _EarningsActivityEntity() when $default != null:
        return $default(_that.id, _that.type, _that.title, _that.subtitle,
            _that.amount, _that.timestamp);
      case _:
        return orElse();
    }
  }
...
class _EarningsActivityEntity implements EarningsActivityEntity {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EarningsActivityEntityCopyWith<_EarningsActivityEntity> get copyWith =>
      __$EarningsActivityEntityCopyWithImpl<_EarningsActivityEntity>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _EarningsActivityEntity &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.type, type) || other.type == type) &&
            (identical(other.title, title) || other.title == title) &&
            (identical(other.subtitle, subtitle) ||
...
/// @nodoc
abstract mixin class _$EarningsActivityEntityCopyWith<$Res>
    implements $EarningsActivityEntityCopyWith<$Res> {
  factory _$EarningsActivityEntityCopyWith(_EarningsActivityEntity value,
          $Res Function(_EarningsActivityEntity) _then) =
      __$EarningsActivityEntityCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
mixin _$EarningsEntity {
  ...
  double get hours;
  double get rating;
  List<EarningsActivityEntity> get recentActivities;

  /// Create a copy of EarningsEntity
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $EarningsEntityCopyWith<EarningsEntity> get copyWith =>
      _$EarningsEntityCopyWithImpl<EarningsEntity>(
          this as EarningsEntity, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is EarningsEntity &&
...
abstract mixin class $EarningsEntityCopyWith<$Res> {
  factory $EarningsEntityCopyWith(
          EarningsEntity value, $Res Function(EarningsEntity) _then) =
      _$EarningsEntityCopyWithImpl;
  @useResult
  $Res call(
      ...
      double hours,
      double rating,
      List<EarningsActivityEntity> recentActivities});
}
...
extension EarningsEntityPatterns on EarningsEntity {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_EarningsEntity value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(double totalEarnings, int trips, double hours,
            double rating, List<EarningsActivityEntity> recentActivities)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _EarningsEntity() when $default != null:
        return $default(_that.totalEarnings, _that.trips, _that.hours,
            _that.rating, _that.recentActivities);
      case _:
        return orElse();
    }
  }
...
class _EarningsEntity implements EarningsEntity {
  const _EarningsEntity(
      {required this.totalEarnings,
      required this.trips,
      required this.hours,
      required this.rating,
      required final List<EarningsActivityEntity> recentActivities})
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EarningsEntityCopyWith<_EarningsEntity> get copyWith =>
      __$EarningsEntityCopyWithImpl<_EarningsEntity>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _EarningsEntity &&
            (identical(other.totalEarnings, totalEarnings) ||
                other.totalEarnings == totalEarnings) &&
            (identical(other.trips, trips) || other.trips == trips) &&
            (identical(other.hours, hours) || other.hours == hours) &&
...
/// @nodoc
abstract mixin class _$EarningsEntityCopyWith<$Res>
    implements $EarningsEntityCopyWith<$Res> {
  factory _$EarningsEntityCopyWith(
          _EarningsEntity value, $Res Function(_EarningsEntity) _then) =
      __$EarningsEntityCopyWithImpl;
  @override
  @useResult
  $Res call(
      {double totalEarnings,
