...
mixin _$RideRequestEntity {
  ...
  $RideRequestEntityCopyWith<RideRequestEntity> get copyWith =>
      _$RideRequestEntityCopyWithImpl<RideRequestEntity>(
          this as RideRequestEntity, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RideRequestEntity &&
...
abstract mixin class $RideRequestEntityCopyWith<$Res> {
  factory $RideRequestEntityCopyWith(
          RideRequestEntity value, $Res Function(RideRequestEntity) _then) =
      _$RideRequestEntityCopyWithImpl;
  @useResult
  $Res call(
      {int id,
...
extension RideRequestEntityPatterns on RideRequestEntity {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RideRequestEntity value)? $default, {
...
class _RideRequestEntity implements RideRequestEntity {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RideRequestEntityCopyWith<_RideRequestEntity> get copyWith =>
      __$RideRequestEntityCopyWithImpl<_RideRequestEntity>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RideRequestEntity &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.pickupAddress, pickupAddress) ||
                other.pickupAddress == pickupAddress) &&
            (identical(other.dropAddress, dropAddress) ||
...
/// @nodoc
abstract mixin class _$RideRequestEntityCopyWith<$Res>
    implements $RideRequestEntityCopyWith<$Res> {
  factory _$RideRequestEntityCopyWith(
          _RideRequestEntity value, $Res Function(_RideRequestEntity) _then) =
      __$RideRequestEntityCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int id,
