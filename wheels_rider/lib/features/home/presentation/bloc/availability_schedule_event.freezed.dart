...
part of 'availability_schedule_event.dart';
...
/// @nodoc
mixin _$AvailabilityScheduleEvent {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AvailabilityScheduleEvent);
}
...
@override
String toString() {
  return 'AvailabilityScheduleEvent()';
}
...
/// @nodoc
class $AvailabilityScheduleEventCopyWith<$Res>  {
$AvailabilityScheduleEventCopyWith(AvailabilityScheduleEvent _, $Res Function(AvailabilityScheduleEvent) __);
}


/// Adds pattern-matching-related methods to [AvailabilityScheduleEvent].
extension AvailabilityScheduleEventPatterns on AvailabilityScheduleEvent {
...
class _Fetch implements AvailabilityScheduleEvent {
  const _Fetch();
...
@override
String toString() {
  return 'AvailabilityScheduleEvent.fetch()';
}
