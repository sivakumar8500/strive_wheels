...
mixin _$VerifyOtpResponse {
  ...
  $VerifyOtpResponseCopyWith<VerifyOtpResponse> get copyWith =>
      _$VerifyOtpResponseCopyWithImpl<VerifyOtpResponse>(
          this as VerifyOtpResponse, _$identity);
...
abstract mixin class $VerifyOtpResponseCopyWith<$Res> {
  factory $VerifyOtpResponseCopyWith(
          VerifyOtpResponse value, $Res Function(VerifyOtpResponse) _then) =
...
extension VerifyOtpResponsePatterns on VerifyOtpResponse {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool success, String message, VerifyOtpData data,
            dynamic error, dynamic meta)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _VerifyOtpResponse implements VerifyOtpResponse {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$VerifyOtpResponseToJson(
      this,
    );
  }
...
abstract mixin class _$VerifyOtpResponseCopyWith<$Res>
  ...
  factory _$VerifyOtpResponseCopyWith(
          _VerifyOtpResponse value, $Res Function(_VerifyOtpResponse) _then) =
...
mixin _$VerifyOtpData {
  ...
  @JsonKey(name: 'rider_profile')
  RiderProfile? get riderProfile;
  @JsonKey(name: 'customer_profile')
  dynamic get customerProfile;
  @JsonKey(name: 'driver_registration')
  DriverRegistration? get driverRegistration;
  ...
  $VerifyOtpDataCopyWith<VerifyOtpData> get copyWith =>
      _$VerifyOtpDataCopyWithImpl<VerifyOtpData>(
          this as VerifyOtpData, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.driverRegistration, driverRegistration) ||
                other.driverRegistration == driverRegistration));
  }
...
abstract mixin class $VerifyOtpDataCopyWith<$Res> {
  factory $VerifyOtpDataCopyWith(
          VerifyOtpData value, $Res Function(VerifyOtpData) _then) =
      _$VerifyOtpDataCopyWithImpl;
  @useResult
  $Res call(
...
class _$VerifyOtpDataCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? driverRegistration = freezed,
  }) {
    return _then(_self.copyWith(
      ...
      customerProfile: freezed == customerProfile
          ? _self.customerProfile
          : customerProfile // ignore: cast_nullable_to_non_nullable
              as dynamic,
      driverRegistration: freezed == driverRegistration
          ? _self.driverRegistration
          : driverRegistration // ignore: cast_nullable_to_non_nullable
  ...
  $DriverRegistrationCopyWith<$Res>? get driverRegistration {
    ...
    return $DriverRegistrationCopyWith<$Res>(_self.driverRegistration!,
        (value) {
...
extension VerifyOtpDataPatterns on VerifyOtpData {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VerifyOtpData value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _VerifyOtpData implements VerifyOtpData {
  const _VerifyOtpData(
      ...
      @JsonKey(name: 'rider_profile') this.riderProfile,
      @JsonKey(name: 'customer_profile') this.customerProfile,
      @JsonKey(name: 'driver_registration') this.driverRegistration})
      : _roles = roles;
  ...
  @override
  @JsonKey(name: 'driver_registration')
  final DriverRegistration? driverRegistration;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VerifyOtpDataCopyWith<_VerifyOtpData> get copyWith =>
      __$VerifyOtpDataCopyWithImpl<_VerifyOtpData>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VerifyOtpDataToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$VerifyOtpDataCopyWith<$Res>
    implements $VerifyOtpDataCopyWith<$Res> {
  factory _$VerifyOtpDataCopyWith(
          _VerifyOtpData value, $Res Function(_VerifyOtpData) _then) =
      __$VerifyOtpDataCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'access_token') String accessToken,
