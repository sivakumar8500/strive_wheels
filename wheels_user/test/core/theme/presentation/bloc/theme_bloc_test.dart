...
import 'package:wheels_user/core/theme/domain/usecases/get_theme_mode_usecase.dart';
import 'package:wheels_user/core/theme/domain/usecases/set_theme_mode_usecase.dart';
import 'package:wheels_user/core/theme/presentation/bloc/theme_bloc.dart';
...
void main() {
  ...
  group('ThemeBloc', () {
    ...
    blocTest<ThemeBloc, ThemeState>(
      ...
      build: () {
        when(() => mockSetThemeModeUseCase(ThemeMode.light))
            .thenAnswer((_) async {});
        return themeBloc;
      },
    ...
    blocTest<ThemeBloc, ThemeState>(
      ...
      build: () {
        when(() => mockSetThemeModeUseCase(ThemeMode.dark))
            .thenAnswer((_) async {});
        return themeBloc;
      },
