...
class _LoginPageState extends State<LoginPage> {
                    ...
                    builder: (context, state) {
                      ...
                      return SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: (isLoading || !_isPhoneValid) ? null : _onContinuePressed,
                          style: ElevatedButton.styleFrom(
                            backgroundColor: AppColors.indicatorActive,
                            foregroundColor: AppColors.white,
                            disabledBackgroundColor: AppColors.indicatorActive.withOpacity(0.5),
  ...
  Widget _buildTermsAndPrivacy(bool isDark) {
    final textColor = isDark ? AppColors.textSecondaryDark : AppColors.onboardingTextSecondaryLight;
